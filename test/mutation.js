...
describe('Mutation', () => {
  ...
  describe('Should throw an error if a input field is different', () => {
    it('Should throw an error if the input is number and it must be a string', () => {
      ...
      expect(error).to.be.an.instanceOf(Error)
      expect(error.message).to.be.eq(
        'Variable "$input" got invalid value 1 at "input.username"; String cannot represent a non string value: 1'
      )
    })
    ...
    it('Should throw an error if the input is boolean and it must be a string', () => {
      ...
      expect(error).to.be.an.instanceOf(Error)
      expect(error.message).to.be.eq(
        'Variable "$input" got invalid value true at "input.username"; String cannot represent a non string value: true'
      )
    })
    ...
    it('Should throw an error if the input is string and it must be a number', () => {
      ...
      expect(error).to.be.an.instanceOf(Error)
      expect(error.message).to.be.eq(
        'Variable "$input" got invalid value "10" at "input.age"; Int cannot represent non-integer value: "10"'
      )
    })
    ...
    it('Should throw an error if the input is boolean and it must be a number', () => {
      ...
      expect(error).to.be.an.instanceOf(Error)
      expect(error.message).to.be.eq(
        'Variable "$input" got invalid value true at "input.age"; Int cannot represent non-integer value: true'
      )
    })
  ...
  describe('Should return selected fields', () => {
    ...
    it('Should fail if the mutations has any extra argument', () => {
      ...
      expect(error).to.exist
      expect(error.message).to.be.eq(
        'Unknown argument "name" on field "Mutation.updateUserScores".'
      )
    })
    ...
    it('Should fail if the mutations has no argument', () => {
      ...
      expect(error).to.exist
      expect(error.message).to.be.eq(
        'Variable "$input" got invalid value [true] at "input.isAdmin"; Boolean cannot represent a non boolean value: [true]'
      )
    })
  })
