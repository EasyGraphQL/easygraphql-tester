...
class Tester {
  ...
  mock (opts, args = {}) {
    ...
    const operationOptions = Object.assign({}, this.opts, opts)

    // Todo: add automock option, to return only values that are on the fixture, after
    // validation
    let { query, variables, fixture, saveFixture = false } = operationOptions
