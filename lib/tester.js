...
class Tester {
  constructor (schema) {
    ...
    this.mock = mocker(schema)
  }

  test (query, args = {}) {
    if (!query) {
      throw new Error('The Query is require')
    }
    ...
    switch (operationType.toLowerCase()) {
      case 'query':
        ...
        mock = validator(parsedQuery, this.mock.Query[name])
      ...
      case 'mutation':
        ...
        mock = validator(parsedQuery, this.mock.Mutation[name])
