...
class Tester {
  constructor (schema) {
    ...
    this.gqlSchema = buildGraphQLSchema(schema)
  ...
  mock (opts, args = {}) {
    ...
    const errors = validation(this.gqlSchema, query, opts)

    if (isObject(operationOptions) && errors.length) {
      operationOptions.fixture = {
        data: operationOptions.fixture ? operationOptions.fixture.data : null,
        errors: [].concat(
          operationOptions.fixture ? operationOptions.fixture.errors : [],
          errors
        )
      }
    }
    ...
    return mockQuery(this.schema, this.mockedSchema, parsedQuery, operationOptions).mockedQuery
  }
